                ...
                children: <Widget>[
                  new Container(
                    decoration: BoxDecoration(
                      color: CustomColors.nearlyBlue.withOpacity(0.5),
                      ...
                      gradient: LinearGradient(
                        colors: [
                          CustomColors.nearlyBlue.withOpacity(0.2),
                          CustomColors.nearlyBlue.withOpacity(0.5)
                        ],
                ...
                children: <Widget>[
                  new Container(
                    decoration: BoxDecoration(
                      ...
                      gradient: LinearGradient(
                        colors: [
                          CustomColors.nearlyBlue.withOpacity(0.4),
                          CustomColors.nearlyBlue
                        ],
                        begin: Alignment.topLeft,
                        end: Alignment.bottomRight,
                      ),
            ...
            Positioned(
              ...
              child: new ScaleTransition(
                ...
                child: Container(
                  ...
                  height: 2,
                  decoration: BoxDecoration(
                    color: CustomColors.nearlyWhite.withOpacity(0.4),
            ...
            Positioned(
              ...
              child: new Transform(
                ...
                child: Container(
                  ...
                  height: 4,
                  decoration: BoxDecoration(
                    color: CustomColors.nearlyWhite.withOpacity(
